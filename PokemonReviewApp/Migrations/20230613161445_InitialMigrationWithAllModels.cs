    ...
    public partial class InitialMigrationWithAllModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reivews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reivews_Pokemons_PokemonId",
                        column: x => x.PokemonId,
                        principalTable: "Pokemons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reivews_Reviewers_ReviewerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reivews_PokemonId",
                table: "Reivews",
                column: "PokemonId");

            migrationBuilder.CreateIndex(
                name: "IX_Reivews_ReviewerId",
                table: "Reivews",
                column: "ReviewerId");
        }
